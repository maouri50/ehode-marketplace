...
export const pageContent = {
  ...
  privacy: {
    ...
    sections: [
      ["Information collected", "Ehode receives the information you submit when you contact the shop, join the newsletter, create a buyer account, or complete an order. This can include your name, email address, account information, order details, and message content."],
      ["How information is used", "Information is used to operate the storefront, process and deliver eligible downloads, provide purchase access, respond to support requests, protect the service, and send marketing emails only when you choose to subscribe."],
      ["Payments and service providers", "PayPal processes payment information during checkout. Ehode uses service providers for hosting, email delivery, secure file delivery, and website analytics. Those services may process information needed to perform their role."],
